...
namespace eval ::optrace {
  variable script "/media/sytrics/Storage/git/EVEEX-FPGA/memory_to_macroblock/project_1/project_1.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /media/sytrics/Storage/git/EVEEX-FPGA/memory_to_macroblock/project_1/project_1.runs/synth_1/top.dcp
